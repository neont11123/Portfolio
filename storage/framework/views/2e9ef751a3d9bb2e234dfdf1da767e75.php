          ...
          <div class="col-lg-6 order-2 order-lg-1">
            <div class="hero-content">
              ...
              <div class="hero-actions" data-aos="fade-up" data-aos-delay="500">
                <a href="<?php echo e(route('portfolio')); ?>" class="btn btn-primary">View My Work</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampps\htdocs\folioone-laravel\resources\views/index.blade.php ENDPATH**/ ?>