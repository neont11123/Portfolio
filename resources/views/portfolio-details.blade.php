      ...
      <img src="{{ asset('img/portfolio/ud1.png') }}"
          ...
          <div class="thumbnail-grid" data-aos="fade-up" data-aos-delay="200">
            <div class="row g-2 mt-3">
              ...
              <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/d3.png') }}"  class="img-fluid glightbox">
              </div>
              <div class="col-3 d-flex justify-content-center align-items-center">
    ...
    <a href="{{ asset('img/portfolio/3.png') }}"
      ...
      <img src="{{ asset('img/portfolio/3.png') }}"
          ...
          <div class="thumbnail-grid" data-aos="fade-up" data-aos-delay="200">
            <div class="row g-2 mt-3">
              ...
              <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/5.png') }}"  class="img-fluid glightbox">
              </div>
              <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/3.png') }}"  class="img-fluid glightbox">
              </div>
              <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/2.png') }}"  class="img-fluid glightbox">
              </div>
            </div>
          </div>
      ...
      <div class="col-lg-6" data-aos="fade-left">
        <div-- class="portfolio-details-content">
          ...
          <div class="cta-buttons" data-aos="fade-up" data-aos-delay="400">
            <a href="{{ url('portfolio-details/' . ($id - 1)) }}" class="btn-next-project"><i class="bi bi-arrow-left">  Previous</i></a>
            <a href="{{ url('portfolio-details/' . ($id + 1)) }}" class="btn-view-project">Next Project <i class="bi bi-arrow-right"></i></a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="portfolio-details-media">
          <div class="main-image">
            <div class="portfolio-details-slider swiper init-swiper" data-aos="zoom-in">
              ...
              <div class="swiper-wrapper">
<div class="swiper-slide">
  <a href="{{ asset('img/portfolio/i2.png') }}"
     class="glightbox"
     data-gallery="portfolio-gallery">
    <img src="{{ asset('img/portfolio/i2.png') }}"
         alt="Portfolio Image"
         class="img-fluid">
  </a>
</div>
...
<div class="swiper-slide">
  <a href="{{ asset('img/portfolio/i3.png') }}"
     class="glightbox"
     data-gallery="portfolio-gallery">
    <img src="{{ asset('img/portfolio/i3.png') }}"
         alt="Portfolio Image"
         class="img-fluid">
  </a>
</div>
...
<div class="swiper-slide">
  <a href="{{ asset('img/portfolio/i4.png') }}"
     class="glightbox"
     data-gallery="portfolio-gallery">
    <img src="{{ asset('img/portfolio/i4.png') }}"
         alt="Portfolio Image"
         class="img-fluid">
  </a>
</div>
          ...
          <div class="thumbnail-grid" data-aos="fade-up" data-aos-delay="200">
            <div class="row g-2 mt-3">
                ...
                <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/i6.png') }}"  class="img-fluid glightbox">
                </div>
                <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/i7.png') }}"  class="img-fluid glightbox">
                </div>
                <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/i8.png') }}"  class="img-fluid glightbox">
                </div>
                <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/i9.png') }}"  class="img-fluid glightbox">
                </div>
                <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/i10.png') }}"  class="img-fluid glightbox">
                </div>
                <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/i11.png') }}"  class="img-fluid glightbox">
                </div>
                <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/i12.png') }}"  class="img-fluid glightbox">
                </div>
            </div>
        </div>
      ...
      <div class="col-lg-6" data-aos="fade-left">
        <div-- class="portfolio-details-content">
          ...
          <div class="cta-buttons" data-aos="fade-up" data-aos-delay="400">
            <a href="{{ url('portfolio-details/' . ($id - 1)) }}" class="btn-next-project"><i class="bi bi-arrow-left"></i>  Previous</a>
            <a href="{{ url('portfolio-details/' . ($id + 1)) }}" class="btn-view-project">Next Project <i class="bi bi-arrow-right"></i></a>
          </div>
        </div>
      </div>
...
<div class="swiper-wrapper">
  <div class="swiper-slide">
    <a href="{{ asset('img/portfolio/posters.png') }}" class="glightbox" data-gallery="portfolio-gallery">
      <img src="{{ asset('img/portfolio/posters.png') }}" alt="Portfolio Image" class="img-fluid">
    </a>
  </div>

  <div class="swiper-slide">
    <a href="{{ asset('img/portfolio/gold2.png') }}" class="glightbox" data-gallery="portfolio-gallery">
      <img src="{{ asset('img/portfolio/gold2.png') }}" alt="Portfolio Image" class="img-fluid">
    </a>
  </div>

  <div class="swiper-slide">
    <a href="{{ asset('img/portfolio/a1.png') }}" class="glightbox" data-gallery="portfolio-gallery">
      <img src="{{ asset('img/portfolio/a1.png') }}" alt="Portfolio Image" class="img-fluid">
    </a>
  </div>

  <div class="swiper-slide">
    <a href="{{ asset('img/portfolio/a2.png') }}" class="glightbox" data-gallery="portfolio-gallery">
      <img src="{{ asset('img/portfolio/a2.png') }}" alt="Portfolio Image" class="img-fluid">
    </a>
  </div>

  <div class="swiper-slide">
    <a href="{{ asset('img/portfolio/a3.png') }}" class="glightbox" data-gallery="portfolio-gallery">
      <img src="{{ asset('img/portfolio/a3.png') }}" alt="Portfolio Image" class="img-fluid">
          ...
          <div class="thumbnail-grid" data-aos="fade-up" data-aos-delay="200">
            <div class="row g-2 mt-3">
                ...
                <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/a1.png') }}"  class="img-fluid glightbox">
                </div>
                <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/a2.png') }}"  class="img-fluid glightbox">
                </div>
                <div class="col-3 d-flex justify-content-center align-items-center">
                <img src="{{ asset('img/portfolio/a3.png') }}"  class="img-fluid glightbox">
                </div>
            </div>
        </div>
